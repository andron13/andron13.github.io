...
4. И пишем в нём ручками код. 
    {{< figure src="/img/res/html/helloworld-1.png" title="helloworld" alt="helloworld" >}}
...
Сначала мы должны закончить прямую речь и закрыть тег _q_ и только потом закрыть родительский тег. Смотрим как мы это сделали в примере.
