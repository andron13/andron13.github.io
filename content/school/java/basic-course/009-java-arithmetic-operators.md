...
|++||Инкремент, а++ соотвествует а = а + 1|
|--||Декремент, а-- соотвествует а = а - 1|
...
Это далеко не простая тема и требует повторения/изучения математической состовляющей. Но теоретически можно изучать Java и дальше, оставив эту тему на когда-нибудь потом, самое главное никому не говорите, что я это сказал. А если серьёзно, то изучив эту тему вы станете на один шаг ближе к "стать программистом".
...
Очень рекомендую последний ресурс - 4. www.baeldung.com. На проекте очень много грамотных постов о Java и из мира Java. Можно ввести в Google запрос "baeldung cast int" и получить прекрасную [статью](https://www.baeldung.com/java-convert-string-to-int-or-integer)  для самостоятельного изучения конвертации данных из типа данных String в int. Ресурс определённо в закладки.
