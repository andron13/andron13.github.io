...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.2ef2146a362d894856cf37b598596632b243f79410f9c743cecefde5a2ffa4bd.js',function(){input.required=false;search();});}
