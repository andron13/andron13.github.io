...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3f329a35bca73f2bf0dc323d1801baeb4b1be6b5297ea1d061fc1a091ddad8c9.js',function(){input.required=false;search();});}
