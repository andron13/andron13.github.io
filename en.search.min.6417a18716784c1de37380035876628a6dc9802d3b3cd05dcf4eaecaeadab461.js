...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6a6bde97a0272ed9f623c2779e3d51dd05d558728742c8c033f0884069eddccf.js',function(){input.required=false;search();});}
