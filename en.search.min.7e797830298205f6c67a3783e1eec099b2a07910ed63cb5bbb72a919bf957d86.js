...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8d649cd1fdc0db2435962c3517b3a14d6be8ab0ca04b22422555b4bccb25c6d1.js',function(){input.required=false;search();});}
