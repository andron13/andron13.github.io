...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.95cde6a334741d9f745239019900527cbab37a9ef5d9e2f2cf443d22c74641ad.js',function(){input.required=false;search();});}
