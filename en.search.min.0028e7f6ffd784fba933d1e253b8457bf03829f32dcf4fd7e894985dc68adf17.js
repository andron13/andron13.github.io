...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.134c603d5935f62ceb3be8e5d21efbe2c38a2ca0865f585eafd1292a587e605a.js',function(){input.required=false;search();});}
