...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.24bc693c2285ff45b18f3e3ebeda5f95bd2c252e55866f384054d3658ba3f956.js',function(){input.required=false;search();});}
