...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.be73347dce3cd757c2f5b39e6b70695f0e6edc5aa4e5687a7a3a792cd30dc72f.js',function(){input.required=false;search();});}
