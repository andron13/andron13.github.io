...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.130c0cca06dff90023560541a04a659019e698bd2d7f7b362c14f71b41fc3beb.js',function(){input.required=false;search();});}
