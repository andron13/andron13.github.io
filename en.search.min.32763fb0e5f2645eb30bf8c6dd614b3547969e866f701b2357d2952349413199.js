...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a6f13fcf22de7e66bd2d1ab89ae46dad07addaa75ac8c57f68543defb93a120a.js',function(){input.required=false;search();});}
