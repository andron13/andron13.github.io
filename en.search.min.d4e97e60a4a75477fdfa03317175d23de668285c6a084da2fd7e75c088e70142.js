...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4453230108fefc6212e2db97f1818418062da5bf9281712a33c6f06e6562d308.js',function(){input.required=false;search();});}
